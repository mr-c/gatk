...
public final class VariantAnnotatorEngine {
    ...
    /**
     * * Makes the engine given a list of annotations generated by the the command line parser.
     * @param annotationList List of annotation objects with user argument parameters already set which should be applied
     *                       by the engine when annotating VariantContexts
     ...
     * @param useRaw Boolean value indicating whether the engine should output its reducible annotations in their raw form
     */
